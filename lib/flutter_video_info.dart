...
class VideoData {
  ...
  VideoData.fromJson(Map<String, dynamic> json) {
    ...
    mimetype = (json["mimetype"] == null || json["mimetype"] == "") ? null : (json["mimetype"]);
    date = (json["date"] == null || json["date"] == '') ? null : json["date"];
    location = (json["location"] == null || json["location"] == '') ? null : json["location"];
    framerate = double.tryParse("${json["framerate"]}");
    author = (json['author'] == null || json['author'] == '') ? null : json['author'];
    width = int.tryParse('${json['width']}');
    height = int.tryParse('${json['height']}');
    orientation = json["orientation"] != null ? int.tryParse(json["orientation"]) : null;
